...
class Batch010CutoverHistory {
  ...
  artifact() {
    ...
    const sourcePath = PROFILE.executionProfile.expectedTargets[0].targetPath;
    const newFiles = [sourcePath, ...prebuild.preliminaryMetadata.plannedActivationPositions
...
module.exports = { Batch010CutoverHistory };

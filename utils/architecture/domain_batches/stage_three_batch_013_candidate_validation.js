...
class Batch013CandidateValidation {
  run({ app, report, contract, readOutput, instrumented = false,
    ...
    assert(runtimePosition < earliestNew, "runtime must load before batch 013 providers");
...
module.exports = { Batch013CandidateValidation };

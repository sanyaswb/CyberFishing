...
const AUTOMATED = "architecture/migration/stage_3_batch_014_automated_acceptance.json";
const ACCEPTANCE = "architecture/migration/stage_3_batch_014_acceptance_pass.json";
const BROWSER = "architecture/migration/stage_3_batch_014_browser_confirmation.json";

class Batch014BrowserAcceptanceRecorder {
  ...
  run({ sessionStatement, consoleStatement, errors, warnings }) {
    ...
    assert(sessionStatement.includes("PASS"), "Manual batch 014 browser smoke must be a user-reported PASS");
    ...
    const acceptance = {
      schemaVersion: 1, kind: "cyber-fishing-stage-3-batch-014-acceptance",
      ...
      browserSmoke: {
        ...
        context: "Response to the Stage 3.14.8 Fishing checklist: casting, fish direction and response, rod control, pressure, fatigue and stamina during a catch.",
      ...
      nextStage: "Stage 3.14.9 — Release Closure v0.24.51",
    };
    const acceptanceBytes = serialize(acceptance);
    const browser = {
      schemaVersion: 1, kind: "cyber-fishing-stage-3-batch-014-browser-confirmation",
      ...
      browserSummary: {
        userStatement: sessionStatement,
        context: "User-reported PASS for the Stage 3.14.8 Fishing checklist.",
...
module.exports = { Batch014BrowserAcceptanceRecorder, AUTOMATED, ACCEPTANCE, BROWSER };

...
const AUTOMATED = "architecture/migration/stage_3_batch_013_automated_acceptance.json";
const ACCEPTANCE = "architecture/migration/stage_3_batch_013_acceptance_pass.json";
const BROWSER = "architecture/migration/stage_3_batch_013_browser_confirmation.json";

class Batch013BrowserAcceptanceRecorder {
  ...
  run({ sessionStatement, consoleStatement, errors, warnings }) {
    ...
    assert(sessionStatement.includes("PASS"), "Manual batch 013 browser smoke must be a user-reported PASS");
    ...
    const acceptance = {
      schemaVersion: 1, kind: "cyber-fishing-stage-3-batch-013-acceptance",
      ...
      browserSmoke: {
        ...
        context: "Response to the Stage 3.13.8 Fishing checklist: casting, fish direction and response, rod control, pressure, fatigue and stamina during a catch.",
      ...
      nextStage: "Stage 3.13.9 — Release Closure v0.24.50",
    };
    const acceptanceBytes = serialize(acceptance);
    const browser = {
      schemaVersion: 1, kind: "cyber-fishing-stage-3-batch-013-browser-confirmation",
      ...
      browserSummary: {
        userStatement: sessionStatement,
        context: "User-reported PASS for the Stage 3.13.8 Fishing checklist.",
...
module.exports = { Batch013BrowserAcceptanceRecorder, AUTOMATED, ACCEPTANCE, BROWSER };

...
const PATHS = Object.freeze({
  executionPlan: BATCH_008_EXECUTION_PROFILE.executionPlanPath,
  output: BATCH_008_EXECUTION_PROFILE.testMatrixPath,
});
...
if (require.main === module) {
  ...
  writeMatrix(matrix);
  console.log(
    `Stage 3.8.2 focused matrix generated: ${matrix.behaviorCases.length} behavior cases, ` +

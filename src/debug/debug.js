...
function renderRodPullModule(ctx) {
  ...
  console.table({
    ...
    "Rod hold kg": fmt(live.rodPullForceKg, 3),
    "Effective rod hold kg": fmt(live.effectiveRodHoldKg, 3),
    "Hold tension ratio": fmt(live.holdTensionRatio, 3),
    "Player hold tension kg": fmt(live.playerHoldTensionKg, 3),
    "Fish opposition kg": fmt(live.fishOppositionKg ?? live.totalFishForceKg, 3),

class FightRodHoldSection extends FightSectionBase {
  ...
  rows(d) {
    ...
    return [
      ...
      this.row("Rod hold tension ceiling", `${f.kg(d.rodHoldTensionCeilingKg, 3)} (${f.percent(d.rodHoldTensionCeilingMultiplier, 1)} of rod limit)`, Number(d.rodHoldTensionCeilingMultiplier) > 1 ? "#ff8888" : "#73c2fb"),

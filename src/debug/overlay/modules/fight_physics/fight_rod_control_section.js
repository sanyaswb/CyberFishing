class FightRodControlSection extends FightSectionBase {
  ...
  rows(d) {
    ...
    return [
      ...
      this.row("Max allowed total tension", `${f.kg(d.rodControlTensionCeilingKg, 3)} (${f.percent(d.rodControlTensionCeilingMultiplier, 1)} of rod limit)`, Number(d.rodControlTensionCeilingMultiplier) > 1 ? "#ff8888" : "#73c2fb"),
      ...
      this.row("Centered start", d.rodControlCenterStartActive ? "active" : d.rodControlCentered ? "ready" : "no", d.rodControlCenterStartActive ? "#00ff80" : d.rodControlCentered ? "#73c2fb" : "#8a9bac"),

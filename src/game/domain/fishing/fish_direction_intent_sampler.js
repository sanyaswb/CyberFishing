export const DEFAULT_FISH_RADIAL_RANGE = Object.freeze([0.35, 1]);
export const DEFAULT_FISH_LATERAL_RANGE = Object.freeze([-1, 1]);

export class FishDirectionIntentSampler {
  #rng;

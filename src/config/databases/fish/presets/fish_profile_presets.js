...
const PEACEFUL_DIRECTION = Object.freeze({
  idle: Object.freeze({ radialRange: [-0.25, 0.45], lateralRange: [-0.8, 0.8], agility: 0.35 }),
  rest: Object.freeze({ radialRange: [-0.5, 0.15], lateralRange: [-0.6, 0.6], agility: 0.25 }),
  swim: Object.freeze({ radialRange: [0.35, 1], lateralRange: [-0.9, 0.9], agility: 0.45 }),
...
const PREDATOR_DIRECTION = Object.freeze({
  idle: Object.freeze({ radialRange: [-0.1, 0.55], lateralRange: [-0.9, 0.9], agility: 0.6 }),
  rest: Object.freeze({ radialRange: [-0.35, 0.2], lateralRange: [-0.65, 0.65], agility: 0.4 }),
  swim: Object.freeze({ radialRange: [0.45, 1], lateralRange: [-1, 1], agility: 0.9 }),
...
const FISH_PROFILE_PRESETS = Object.freeze({
  passiveTrainingFish: Object.freeze({
    ...
    behaviorProfile: Object.freeze({
      behaviors: Object.freeze({
        idle: Object.freeze({ forceMultiplier: 0, speedMultiplier: 0, direction: PEACEFUL_DIRECTION.idle, minTime: 500, maxTime: 3000, weight: 25 }),
        rest: Object.freeze({ forceMultiplier: 0, speedMultiplier: 0, direction: PEACEFUL_DIRECTION.rest, minTime: 500, maxTime: 2500, weight: 25 }),
        swim: Object.freeze({ forceMultiplier: 0, speedMultiplier: 0, direction: PEACEFUL_DIRECTION.swim, minTime: 2000, maxTime: 4000, weight: 25 }),
  ...
  activePredator: Object.freeze({
    ...
    behaviorProfile: Object.freeze({
      behaviors: Object.freeze({
        idle: Object.freeze({ forceMultiplier: 0.2, speedMultiplier: 0.0, direction: PREDATOR_DIRECTION.idle, minTime: 1000, maxTime: 3000, weight: 20 }),
        rest: Object.freeze({ forceMultiplier: 0.1, speedMultiplier: 0.0, direction: PREDATOR_DIRECTION.rest, minTime: 500, maxTime: 2500, weight: 15 }),
        swim: Object.freeze({ forceMultiplier: 0.8, speedMultiplier: 0.6, direction: PREDATOR_DIRECTION.swim, minTime: 2000, maxTime: 4000, weight: 40 }),
  ...
  smallPeaceful: Object.freeze({
    ...
    behaviorProfile: Object.freeze({
      behaviors: Object.freeze({
        idle: Object.freeze({ forceMultiplier: 0.1, speedMultiplier: 0.0, direction: PEACEFUL_DIRECTION.idle, minTime: 1000, maxTime: 3500, weight: 30 }),
        rest: Object.freeze({ forceMultiplier: 0.05, speedMultiplier: 0.0, direction: PEACEFUL_DIRECTION.rest, minTime: 800, maxTime: 2500, weight: 25 }),
        swim: Object.freeze({ forceMultiplier: 0.45, speedMultiplier: 0.45, direction: PEACEFUL_DIRECTION.swim, minTime: 2000, maxTime: 4500, weight: 35 }),

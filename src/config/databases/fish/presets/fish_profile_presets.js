...
const FISH_PROFILE_PRESETS = Object.freeze({
  passiveTrainingFish: Object.freeze({
    ...
    behaviorProfile: Object.freeze({
      behaviors: Object.freeze({
        idle: Object.freeze({ powerRatio: 0, speedRatio: 0, minTime: 500, maxTime: 3000, weight: 25 }),
        rest: Object.freeze({ powerRatio: 0, speedRatio: 0, minTime: 500, maxTime: 2500, weight: 25 }),
        swim: Object.freeze({ powerRatio: 0, speedRatio: 0, minTime: 2000, maxTime: 4000, weight: 25 }),
        dash: Object.freeze({ powerRatio: 0, speedRatio: 0, minTime: 1000, maxTime: 2200, weight: 25 }),
  ...
  activePredator: Object.freeze({
    ...
    behaviorProfile: Object.freeze({
      behaviors: Object.freeze({
        idle: Object.freeze({ powerRatio: 0.2, speedRatio: 0, minTime: 1000, maxTime: 3000, weight: 20 }),
        rest: Object.freeze({ powerRatio: 0.1, speedRatio: 0, minTime: 500, maxTime: 2500, weight: 15 }),
        swim: Object.freeze({ powerRatio: 0.8, speedRatio: 0.6, minTime: 2000, maxTime: 4000, weight: 40 }),
        dash: Object.freeze({ powerRatio: 1.2, speedRatio: 1.0, minTime: 1000, maxTime: 2200, weight: 25 }),
        lastDash: Object.freeze({ ...COMMON_LAST_DASH_BEHAVIOR, powerRatio: 2.5, speedRatio: 1.4 }),
      }),
    }),
  }),
  ...
  smallPeaceful: Object.freeze({
    ...
    behaviorProfile: Object.freeze({
      behaviors: Object.freeze({
        idle: Object.freeze({ powerRatio: 0.1, speedRatio: 0, minTime: 1000, maxTime: 3500, weight: 30 }),
        rest: Object.freeze({ powerRatio: 0.05, speedRatio: 0, minTime: 800, maxTime: 2500, weight: 25 }),
        swim: Object.freeze({ powerRatio: 0.45, speedRatio: 0.45, minTime: 2000, maxTime: 4500, weight: 35 }),
        dash: Object.freeze({ powerRatio: 0.8, speedRatio: 0.8, minTime: 800, maxTime: 1800, weight: 10 }),
        lastDash: COMMON_LAST_DASH_BEHAVIOR,
      }),
    }),
  }),

const SLOT_CONFIG = {
  ...
  feederRig: {
    type: "single",
    dependencies: ["feederChum"],
    acceptTypes: ["feeder_rig"],
  },
  hooks: {
    type: "array",
    dependencies: ["baits"],
...
const UI_LAYOUT_CONFIG = [
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "feederRig", label: "Фідерна оснастка" },
...
const CONFIG = {
  ...
  debug: {
    ...
    godMode: {
      ...
      forceAnomalyChance: false, // Якщо true, шанс аномалії для дозволеного виду й локації стає 100%, включно з Fixed Catch.
